...
/*  @GetMapping(path = "/hello", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @PostMapping(path = "/validatetoken", produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<String> activateAcct(@RequestParam("token") String token,
      HttpServletRequest httpServletRequest) {
    UserModel userModel = new UserModel();
    try {
      populateUserModel(userModel, token, JWTUtil.getUserNameFromRequest(httpServletRequest));
